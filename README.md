...
This repository serves as a dev/staging environment for publishing model2owl documentation. A manually triggered workflow builds the documentation from sources stored in the given repository. The default repository is [OP-TED/ted-model2owl-docs](https://github.com/OP-TED/ted-model2owl-docs) repository.
...
## Usage
1. Find a branch containing documentation sources ([a list of active branches for OP-TED/ted-model2owl-docs](https://github.com/OP-TED/ted-model2owl-docs/branches/active))
